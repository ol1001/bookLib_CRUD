$(function () {
    ...
    $.getJSON("http://localhost:8083/getbook", function (data) {
        ...
        $.each(data, function (index, item) {
            ...
            '<img class="open" src="../../img/open.png"></a></td><td>' + item.published +
            '</td><td>' + item.genre +
            '</td><td><a href="#" class="deleteItem" rel="' + this._id + '"><img src="../../img/trash.png" alt="Delete"/></a>' +
            '<br/><a href="#" class="updateItem" rel="' + this._id + '"><img src="../../img/edit.png" alt="Edit"/></a></td></tr>';
            count = index;
        });
        var lastRow = '<tr><td class="index" >' + ++count + '</td>' +
            ...
            '<td><a href="#" class="addItem"><img src="../../img/add.png" alt="Add"/></a><br/>' +
